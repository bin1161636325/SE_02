...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"Erguotou","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 12 */
/*!************************************************************!*\
  !*** D:/二锅骰/Erguotou/node_modules/animate.css/animate.css ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    getFirst: function getFirst(state, data) {
      state.first = data;
    },
    getOther_name: function getOther_name(state, data) {
      state.other_name = data;
    },
    getOther_url: function getOther_url(state, data) {
      state.other_url = data;
    },
    getPlay1_name: function getPlay1_name(state, data) {
      state.play1_name = data;
    },
    getPlay2_name: function getPlay2_name(state, data) {
      state.play2_name = data;
    },
    getPlay1_url: function getPlay1_url(state, data) {
      state.play1_url = data;
    },
    getPlay2_url: function getPlay2_url(state, data) {
      state.play2_url = data;
    },
    getUser_url: function getUser_url(state, data) {
      state.user_url = data;
    },
    getUser_name: function getUser_name(state, data) {
      state.user_name = data;
    },
    getWinner: function getWinner(state, data) {
      state.winner = data;
    },
    getLoser: function getLoser(state, data) {
      state.loser = data;
    },
    getPoint_1: function getPoint_1(state, data) {
      state.point_1 = data;
    },
    getPoint_2: function getPoint_2(state, data) {
      state.point_2 = data;
    } },
...
/* 15 */
/*!******************************************************************************************!*\
  !*** D:/二锅骰/Erguotou/node_modules/@escook/request-miniprogram/miniprogram_dist/index.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
